-- Central de Acolhimento - Schema inicial (profiles, membros, contatos_tci, interacoes_cuidado)
-- Ref.: docs/architecture/system-design-document.md, docs/architecture/auth-design.md

-- 1. ENUMs (valores textuais alinhados ao .NET)
