...
export default function GlobalError({
  ...
  useEffect(() => {
    ...
    console.error("Erro global capturado pelo Next.js:", error);
  }, [error]);

  return (
    <html lang="pt-BR">
      <body
        className="bg-mesh flex min-h-screen flex-col items-center justify-center p-4 text-center font-sans antialiased"
        style={{ background: "var(--bg)", color: "var(--text)", margin: 0 }}
      >
        <div
        ...
        >
          ...
          >
            Ocorreu uma falha grave na inicialização da Central de Acolhimento.
          </p>
