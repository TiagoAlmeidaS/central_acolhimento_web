...
- [Inventario de dados do painel](database/inventario-dados-painel.html) — auditoria do modelo: o que o painel consegue medir hoje, onde a medicao sai errada e as consultas SQL que produzem os numeros.
